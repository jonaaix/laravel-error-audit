...
const siteData = deserializeFunctions(JSON.parse('{"lang":"en-US","dir":"ltr","title":"Laravel Error Audit","description":"AI-assisted daily audit of your Laravel log files, delivered by email.","base":"/laravel-error-audit/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"nav":[{"text":"Getting Started","link":"/quick-start"},{"text":"Configuration","link":"/configuration"}],"sidebar":[{"text":"Guide","items":[{"text":"Getting Started","link":"/quick-start"},{"text":"Configuration","link":"/configuration"}]}],"socialLinks":[{"icon":"github","link":"https://github.com/aaix/laravel-error-audit"}],"footer":{"message":"Released under the MIT License.","copyright":"Copyright © 2026 Jonas Gnioui"},"search":{"provider":"local"}},"locales":{},"scrollOffset":134,"cleanUrls":true}'));
...
function pathToFile(path) {
  ...
  {
    if (inBrowser) {
      const base = "/laravel-error-audit/";
...
const _sfc_main$s = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => import("./VPLocalSearchBox.eRl62j8R.js"));
