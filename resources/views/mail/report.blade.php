...
@if (count($sections) > 1)
<table class="audit-channel-divider{{ $channel === $queueChannel ? ' audit-channel-divider-queue' : '' }}" width="100%" cellpadding="0" cellspacing="0" role="presentation" bgcolor="{{ $channel === $queueChannel ? '#4338ca' : '#3f3f46' }}">
<tr>
